...
# Your correct OULAD assessments data
assessments_data = """code_module,code_presentation,id_assessment,assessment_type,date,weight
...
print("="*60)
print("FIXING assessments.csv FILE")
print("="*60)

# Path to assessments.csv
output_path = Path("data/raw/assessments.csv")
...
if output_path.exists():
    ...
    # Backup
    backup_path = Path("data/raw/assessments_old_backup.csv")
    old_df.to_csv(backup_path, index=False)
    print(f"\n✓ Old file backed up to: {backup_path}")

# Create new correct file
df = pd.read_csv(StringIO(assessments_data))

# Save
df.to_csv(output_path, index=False)

print(f"\n✓ Created CORRECT assessments.csv")
...
if 'id_assessment' in df_verify.columns:
    print(f"\n✓ 'id_assessment' column EXISTS - File is correct!")
    print(f"  Unique assessments: {df_verify['id_assessment'].nunique()}")
else:
    print(f"\n✗ 'id_assessment' column MISSING - Something went wrong!")
